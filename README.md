...
**Zenith Runner** is a premium, high-octane decentralized space/cyber runner game built entirely inside a single-page React app with TypeScript, Vite, and HTML5 Canvas. The game features full Web3 integration on the **GenLayer Testnet**, allowing players to verify their pilots, authorize gameplay sessions, check-in daily, and post high scores onto an on-chain leaderboard using native testnet `GEN` tokens.
...
- **Game Treasury Wallet**: `0xBcBD1169E34799ac9143FD0C350ED06Edb701882`
